...
| **Обработка изображений**           | [Pillow (PIL)](https://pillow.readthedocs.io/)                   | Изменение размера и обработка изображений                                |
...
| **Контейнеризация**                 | Docker (опционально)                                             | Удобный деплой и изоляция окружения                                      |
