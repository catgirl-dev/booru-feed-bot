...
Асинхронный бот, автоматически находящий и отправляющий в чат новые медиафайлы с [Danbooru (Kagamihara)](https://kagamihara.donmai.us/) по указанным пользователем тегам и настройкам, индивидуальным для каждого чата.
